...
<%
	 ...
	 * KindEditor JSP
	 * 
	 * 修改成Struts2适合的版本，原因分析
	 * 调用struts2在上传下载中包装好的request（MultiPartRequestWrapper）中getFille方法
	 *（struts2内部实现中也使用了该插件） 自己实现了文件流的存取
	 * 相当于写了个action
	 */
	...
	System.out.println(wrapper.getFileNames("imgFile").length);
