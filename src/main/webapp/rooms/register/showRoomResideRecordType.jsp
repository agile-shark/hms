...
<html>
  ...
  <body background="images/b.jpg">
	<div id="content">
		...
		<form method="post" id="addForm" action="addroomResAction.action">
			<table width="800" cellspacing="0" cellPadding="0">
				<thead><tr><td colspan="2">顾客入住信息</td></tr></thead>
				<tr>
				...
				<tr>
					...
					<td class="leftTd"><s:property value="roomRes.rrBilling"/></td>
				</tr>
				<tr>
