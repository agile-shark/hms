...
<body>
<div id="left">
<s:iterator value="#parentList" var="parent"><%--ActionContext.getContext().put("parentList", this.accountService.listParent());
--%><ul class="navMenu navSelected">
	<h3 class="navTitle">
		<span class="navTilteTxt"><s:property value="#parent.name"/></span>
	</h3>
	<s:iterator value="#navList" var="module">
		<s:if test="#parent.module_id==#module.parent_id">
			<li class="navChild">
				<a href="<%=request.getContextPath() %>/<s:property value="#module.url"/>" target="content"><s:property value="#module.name"/></a>
			</li>
		</s:if>
	</s:iterator>
