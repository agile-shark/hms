package cn.com.shxt.base.utils.reflect;
...
public class ReflectHelper {
     ...
     * @param propNameAndValue 属性名称(key)和属性值(value)的Map集合
     * @param setNull 当属性值为null时, 是否进行设置
