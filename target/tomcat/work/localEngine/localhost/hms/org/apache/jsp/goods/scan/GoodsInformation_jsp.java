package org.apache.jsp.goods.scan;

import javax.servlet.*;
import javax.servlet.http.*;
import javax.servlet.jsp.*;

public final class GoodsInformation_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("<script type=\"text/javascript\">\r\n");
      out.write("\t\tfunction moduleWin(type, id){\r\n");
      out.write("\t\tvar url = \"\";\r\n");
      out.write("\t\tswitch(type){\r\n");
      out.write("\t\t\tcase 'add':\r\n");
      out.write("\t\t\t\turl = \"");
      out.print(request.getContextPath() );
      out.write("/toAddRoomsJspRoomsAction.action\";\r\n");
      out.write("\t\t\t\tbreak;\r\n");
      out.write("\t\t\tcase 'update':\r\n");
      out.write("\t\t\t\turl = \"");
      out.print(request.getContextPath() );
      out.write("/toUpdateRoomTypeJspRoomsAction.action?roomType.roomType_id=\"+id;\r\n");
      out.write("\t\t\t\tbreak;\r\n");
      out.write("\t\t\tcase 'view':\r\n");
      out.write("\t\t\t\turl = \"");
      out.print(request.getContextPath() );
      out.write("/toLoadRoomTypeJspRoomsAction.action?roomType.roomType_id=\"+id;\r\n");
      out.write("\t\t\t\tbreak;\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\t//调用打开模态窗口\r\n");
      out.write("\t\t//设置属性\r\n");
      out.write("\t\tvar options = new Object();\r\n");
      out.write("\t\toptions.url=url;\r\n");
      out.write("\t\t//传递参数\r\n");
      out.write("\t\toptions.args = {};\r\n");
      out.write("\t\toptions.width=\"600px\";\r\n");
      out.write("\t\toptions.height=\"450px\";\r\n");
      out.write("\t\t\r\n");
      ...
      out.write("\t}\r\n");
      out.write("\t\r\n");
      out.write("\tfunction moduleDel(id){\r\n");
      out.write("\t\tif(window.confirm(\"删除房间类型，需要谨慎，您确定?\")){\r\n");
      out.write("\t\t\tvar url = \"");
      out.print(request.getContextPath() );
      out.write("/delroomTypeAction.action?roomType.roomType_id=\"+id;\r\n");
      out.write("\t\t\t$.ajax({\r\n");
      out.write("\t\t\t\ttype : \"post\",// 请求方式return confirm('确实要删除吗?')\r\n");
      out.write("\t\t\t\turl : url,// 要访问的servlet\r\n");
      out.write("\t\t\t\tdataType : \"text\"// 访问成功后，返回的数据格式，是xml,html还是其他\r\n");
      out.write("\t\t\t});\r\n");
      out.write("\t\t\t$(\"#\" + id).remove();\r\n");
      ...
      if (_jspx_meth_s_005fproperty_005f4(_jspx_page_context))
        return;
      out.write("';\r\n");
      out.write("\t\t\tvar page_num = document.getElementById(\"pageNum\");\r\n");
      out.write("\t\t\tif (page_num < 0 || page_num > allPage) {\r\n");
      out.write("\t\t\t\talert(\"抱歉你输入有误!\");\r\n");
      out.write("\t\t\t\treturn false;\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t\tgoodsForm.submit();\r\n");
      ...
      out.write("\t\t\t\t\t\t<a href=\"javascript:void(0)\" onclick=\"moduleWin('add');\">添加商品信息</a>\r\n");
      out.write("\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t</tr>\r\n");
      out.write("\t\t</table>\r\n");
      out.write("\t</div>\r\n");
  ...
  private boolean _jspx_meth_s_005fproperty_005f0(PageContext _jspx_page_context)
    ...
    // /goods/scan/GoodsInformation.jsp(72,18) name = value type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_s_005fproperty_005f1(PageContext _jspx_page_context)
    ...
    // /goods/scan/GoodsInformation.jsp(75,21) name = value type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_s_005fproperty_005f2(PageContext _jspx_page_context)
    ...
    // /goods/scan/GoodsInformation.jsp(104,18) name = value type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_s_005fproperty_005f3(PageContext _jspx_page_context)
    ...
    // /goods/scan/GoodsInformation.jsp(121,18) name = value type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_s_005fproperty_005f3.setValue("pb.pageNow");
  ...
  private boolean _jspx_meth_s_005fproperty_005f4(PageContext _jspx_page_context)
    ...
    // /goods/scan/GoodsInformation.jsp(122,18) name = value type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_s_005fproperty_005f4.setValue("pb.allPage");
  ...
  private boolean _jspx_meth_s_005fform_005f0(PageContext _jspx_page_context)
    ...
    // /goods/scan/GoodsInformation.jsp(136,3) name = action type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_s_005fform_005f0.setAction("GoodsPagegoodsAction.action");
    // /goods/scan/GoodsInformation.jsp(136,3) name = method type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_s_005fform_005f0.setMethod("post");
    // /goods/scan/GoodsInformation.jsp(136,3) name = name type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_s_005fform_005f0.setName("goodsForm");
    ...
    if (_jspx_eval_s_005fform_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      ...
      do {
        ...
        out.write("\r\n");
        out.write("\t\t\t\t\t商品类别\r\n");
        out.write("\t\t\t\t\t<select name=\"query.goodsType\">\r\n");
        out.write("\t\t\t\t\t\t<option value=\"0\">--请选择商品类型名称--</option>\r\n");
        out.write("\t\t\t\t\t\t");
  ...
  private boolean _jspx_meth_s_005fiterator_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_s_005fform_005f0, PageContext _jspx_page_context)
    ...
    // /goods/scan/GoodsInformation.jsp(143,6) name = value type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_s_005fiterator_005f0.setValue("goodsTypesList");
  ...
  private boolean _jspx_meth_s_005fproperty_005f5(javax.servlet.jsp.tagext.JspTag _jspx_th_s_005fiterator_005f0, PageContext _jspx_page_context)
    ...
    // /goods/scan/GoodsInformation.jsp(144,22) name = value type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_s_005fproperty_005f5.setValue("goodsType");
  ...
  private boolean _jspx_meth_s_005fproperty_005f6(javax.servlet.jsp.tagext.JspTag _jspx_th_s_005fiterator_005f0, PageContext _jspx_page_context)
    ...
    // /goods/scan/GoodsInformation.jsp(144,55) name = value type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_s_005fproperty_005f6.setValue("goodsType");
  ...
  private boolean _jspx_meth_s_005fproperty_005f7(javax.servlet.jsp.tagext.JspTag _jspx_th_s_005fform_005f0, PageContext _jspx_page_context)
    ...
    // /goods/scan/GoodsInformation.jsp(151,13) name = value type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_s_005fproperty_005f7.setValue("pb.pageNow");
  ...
  private boolean _jspx_meth_s_005fiterator_005f1(PageContext _jspx_page_context)
    ...
    // /goods/scan/GoodsInformation.jsp(168,4) name = value type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_s_005fiterator_005f1.setValue("pb.list");
    // /goods/scan/GoodsInformation.jsp(168,4) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_s_005fiterator_005f1.setVar("ri");
    // /goods/scan/GoodsInformation.jsp(168,4) name = status type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_s_005fiterator_005f1.setStatus("ty");
    ...
    if (_jspx_eval_s_005fiterator_005f1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      ...
      do {
        ...
        out.write("</td>\r\n");
        out.write("\t\t\t\t\t\t<td>\r\n");
        out.write("\t\t\t\t\t\t\t<a href=\"javascript:void(0)\" onclick=\"moduleDel(");
        if (_jspx_meth_s_005fproperty_005f15(_jspx_th_s_005fiterator_005f1, _jspx_page_context))
          return true;
        out.write(");\">删除</a>\r\n");
        out.write("\t\t\t\t\t\t\t<a href=\"javascript:void(0)\" onclick=\"moduleWin('update', ");
  ...
  private boolean _jspx_meth_s_005fproperty_005f8(javax.servlet.jsp.tagext.JspTag _jspx_th_s_005fiterator_005f1, PageContext _jspx_page_context)
    ...
    // /goods/scan/GoodsInformation.jsp(169,13) name = value type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_s_005fproperty_005f8.setValue("#ri.cd_id");
  ...
  private boolean _jspx_meth_s_005fproperty_005f9(javax.servlet.jsp.tagext.JspTag _jspx_th_s_005fiterator_005f1, PageContext _jspx_page_context)
    ...
    // /goods/scan/GoodsInformation.jsp(170,10) name = value type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_s_005fproperty_005f9.setValue("#ty.index+1");
  ...
  private boolean _jspx_meth_s_005fproperty_005f10(javax.servlet.jsp.tagext.JspTag _jspx_th_s_005fiterator_005f1, PageContext _jspx_page_context)
    ...
    // /goods/scan/GoodsInformation.jsp(171,10) name = value type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_s_005fproperty_005f10.setValue("#ri.goodsName");
  ...
  private boolean _jspx_meth_s_005fproperty_005f11(javax.servlet.jsp.tagext.JspTag _jspx_th_s_005fiterator_005f1, PageContext _jspx_page_context)
    ...
    // /goods/scan/GoodsInformation.jsp(172,10) name = value type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_s_005fproperty_005f11.setValue("#ri.goodsType.goodsType");
  ...
  private boolean _jspx_meth_s_005fproperty_005f12(javax.servlet.jsp.tagext.JspTag _jspx_th_s_005fiterator_005f1, PageContext _jspx_page_context)
    ...
    // /goods/scan/GoodsInformation.jsp(173,10) name = value type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_s_005fproperty_005f12.setValue("#ri.goodsCode");
  ...
  private boolean _jspx_meth_s_005fproperty_005f13(javax.servlet.jsp.tagext.JspTag _jspx_th_s_005fiterator_005f1, PageContext _jspx_page_context)
    ...
    // /goods/scan/GoodsInformation.jsp(174,10) name = value type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_s_005fproperty_005f13.setValue("#ri.goodsPrice");
  ...
  private boolean _jspx_meth_s_005fproperty_005f14(javax.servlet.jsp.tagext.JspTag _jspx_th_s_005fiterator_005f1, PageContext _jspx_page_context)
    ...
    // /goods/scan/GoodsInformation.jsp(175,10) name = value type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_s_005fproperty_005f14.setValue("#ri.goodsDes");
  ...
  private boolean _jspx_meth_s_005fproperty_005f15(javax.servlet.jsp.tagext.JspTag _jspx_th_s_005fiterator_005f1, PageContext _jspx_page_context)
    ...
    // /goods/scan/GoodsInformation.jsp(177,55) name = value type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_s_005fproperty_005f15.setValue("#ri.cd_id");
  ...
  private boolean _jspx_meth_s_005fproperty_005f16(javax.servlet.jsp.tagext.JspTag _jspx_th_s_005fiterator_005f1, PageContext _jspx_page_context)
    ...
    // /goods/scan/GoodsInformation.jsp(178,65) name = value type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_s_005fproperty_005f16.setValue("#ri.cd_id");
  ...
  private boolean _jspx_meth_s_005fproperty_005f17(PageContext _jspx_page_context)
    ...
    // /goods/scan/GoodsInformation.jsp(192,2) name = value type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_s_005fproperty_005f17.setValue("pb.totalCount");
  ...
  private boolean _jspx_meth_s_005fproperty_005f18(PageContext _jspx_page_context)
    ...
    // /goods/scan/GoodsInformation.jsp(194,2) name = value type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_s_005fproperty_005f18.setValue("pb.pageNow");
  ...
  private boolean _jspx_meth_s_005fproperty_005f19(PageContext _jspx_page_context)
    ...
    // /goods/scan/GoodsInformation.jsp(196,2) name = value type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_s_005fproperty_005f19.setValue("pb.allPage");
  ...
  private boolean _jspx_meth_s_005fif_005f0(PageContext _jspx_page_context)
    ...
    // /goods/scan/GoodsInformation.jsp(199,2) name = test type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_s_005fif_005f1(PageContext _jspx_page_context)
    ...
    // /goods/scan/GoodsInformation.jsp(204,3) name = test type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_s_005fif_005f2(PageContext _jspx_page_context)
    ...
    // /goods/scan/GoodsInformation.jsp(209,3) name = test type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_s_005fif_005f3(PageContext _jspx_page_context)
    ...
    // /goods/scan/GoodsInformation.jsp(214,3) name = test type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
